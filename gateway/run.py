...
class GatewayRunner:
    ...
    async def _run_agent(
        ...
        # Feishu topic groups require reply_to with a valid message_id (om_xxx)
        # to keep progress messages inside the thread.  The thread_id (omt_xxx)
        # alone in metadata is not sufficient — the reply API needs a concrete
        # message to anchor the reply to.
